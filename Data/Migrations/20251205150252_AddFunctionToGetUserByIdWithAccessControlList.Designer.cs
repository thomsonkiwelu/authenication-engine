...
namespace conservation_backend.Migrations
{
    ...
    [Migration("20251205150252_AddFunctionToGetUserByIdWithAccessControlList")]
    partial class AddFunctionToGetUserByIdWithAccessControlList
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("conservation_backend.Features.Permissions.PermissionEntity", b =>
                {
                    ...
                    b.Property<string>("ModelTypeSlug")
                        .IsRequired()
                        .HasMaxLength(255)
                        .HasColumnType("character varying(255)");
            ...
            modelBuilder.Entity("conservation_backend.Features.Permissions.SystemModule", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("conservation_backend.Features.Permissions.PermissionEntity", b =>
                {
                    b.HasOne("conservation_backend.Features.Permissions.SystemModule", "SystemModule")
                        .WithMany()
