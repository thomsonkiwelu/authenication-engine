...
namespace conservation_backend.Migrations
{
    ...
    [Migration("20260225020010_UpdateAssignStaffToDepartment_ClearLessStaffPosting")]
    public partial class UpdateAssignStaffToDepartmentClearLessStaffPosting : Migration
    {
            ...
            migrationBuilder.Sql("""
                ...
                AS $BODY$
                    ...
                    BEGIN
                        ...
                        -- Close any active LESS postings for this staff (shift cleanup)
                        UPDATE "LessStaffPostings"
                        SET
                            "EffectiveTo" = NOW(),
                            "UpdatedBy" = v_created_by,
                            "UpdatedAt" = NOW()
                        WHERE "StaffId" = v_staff_id AND "EffectiveTo" IS NULL AND "DeletedAt" IS NULL;
        ...
        {
            // Revert by re-creating the function without LESS posting close is not included here.
        }
    }
}
